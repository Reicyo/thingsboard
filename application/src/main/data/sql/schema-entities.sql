...
CREATE TABLE "public"."data_report" (
                                        ...
                                        "email_account" varchar(255) COLLATE "pg_catalog"."default",
                                        "report_period" varchar(255) COLLATE "pg_catalog"."default",
                                        "report_day" varchar(255) COLLATE "pg_catalog"."default",
                                        "sensors" varchar(255) COLLATE "pg_catalog"."default",
                                        "frequency" int4,
                                        "is_valid" bool,
                                        "message" varchar(255) COLLATE "pg_catalog"."default",
                                        CONSTRAINT "data_report_pkey" PRIMARY KEY ("device_id")
)
;
